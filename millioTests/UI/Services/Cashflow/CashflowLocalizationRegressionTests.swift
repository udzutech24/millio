...
struct CashflowLocalizationRegressionTests {
    ...
    func russianLocaleHasCashflowTranslations() {
        ...
        #expect(AppLocalization.string("New income", locale: locale) == "Новый доход")
        #expect(AppLocalization.string("New expense", locale: locale) == "Новый расход")
        #expect(AppLocalization.string("Recurring income", locale: locale) == "Регулярные доходы")
        #expect(AppLocalization.string("Recurring expenses", locale: locale) == "Регулярные расходы")
        #expect(AppLocalization.string("Planned income", locale: locale) == "Запланированные доходы")
        ...
        #expect(AppLocalization.string("Total income for month", locale: locale) == "Доход за месяц")
