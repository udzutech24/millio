...
struct FinancesMainLayoutPolicyTests {
    ...
    func financeMainUsesSharedSpacingConstants() {
        ...
        #expect(FinancesMainLayoutPolicy.accountsListGroupCornerRadius == 0)
        #expect(FinancesMainLayoutPolicy.accountsListGroupSpacing == 0)
        #expect(FinancesMainLayoutPolicy.accountsListGroupSeparatorHeight == 0.9)
