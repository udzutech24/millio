...
- На экране «Избранные категории» кэшбэка поддержаны редактирование/удаление пользовательских категорий (long press), а в выборе карты добавлен быстрый переход в «Финансы» для создания новой карты.
