...
> **UPD 2026-07-10 (вечер):** по ручной проверке владельца починены 3 бага (пустая карточка баланса на «Счетах», «No products» в Динамике→Accounts, нули активов в Cashflow) — коммиты `350a190`+`2fa8b7a`, гейт 1700/15 = 0 новых, Release проверен визуально на симуляторе iOS 26.2. HEAD теперь `2fa8b7a`. Детали — журнал плана, запись «2026-07-10 (день)». Наблюдения вне скоупа: дубль «Ungrouped» на Счетах (был до фиксов), reloadToken карточки Счетов не слушает core-изменения.
