...
## ✅ Вопросы владельцу — ОТВЕЧЕНЫ (2026-07-12)

1. **Обход паволла:** sign-off получен («фиксани как считаешь лучше») → реализовано Gate C этой же сессией (см. журнал в plan.md): счётчики free-лимитов считают активные core+legacy без двойного счёта twin-пар.
2. **`convertAccountToCore`/`unconvertAccountFromCore`:** ОСТАВИТЬ — владелец сам удалит/перенесёт свою пару легаси-счетов, снос узла после ручной очистки. При контрактном флипе НЕ сносить.
