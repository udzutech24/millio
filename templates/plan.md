...
**Slug:** `feature-slug` (kebab-case, соответствует имени файла `YYYY-MM-DD__feature-slug.md`)
**Дата создания:** YYYY-MM-DD (не меняется при обновлениях)
**Stage:** 3 / Planning
**Spec:** [`specs/YYYY-MM-DD-name.md`](../specs/)
**Research:** [`thoughts/research/YYYY-MM-DD-name.md`](../thoughts/research/)
...
[Опционально, но полезно между чатами. Формат: `YYYY-MM-DD — что поменялось в плане / какая фаза сдвинулась / почему`.]

- `YYYY-MM-DD` — создан план, Phase 1 начата.
- ...
...
**Архивируем:** `mv plans/YYYY-MM-DD__feature-slug.md plans/archive/`
