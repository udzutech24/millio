...
- **AreaMark + LineMark** с плавной monotone-кривой, мягкой градиентной заливкой и Apple-style акцентом на активной точке
...
- Визуальное выделение выбранного диапазона в стиле native range picker
- Вертикальный список месяцев вместо пошаговой навигации стрелками
- Быстрые пресеты периода (`Today`, `7 days`, `Month`, `30 days`, `90 days`, `Year`)
- Блокировка будущих дат
- Акцентная подсветка начала/конца периода и непрерывная заливка диапазона по неделям
