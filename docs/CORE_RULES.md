...
❌ Нет обратных зависимостей (зависимости направлены строго внутрь)  
❌ Нет импорта SwiftUI в Core (кроме инфраструктурных адаптеров навигации)  
❌ Нет изменения Core при добавлении новых фич

### Данные и синхронизация

❌ Нет чтения данных напрямую из CloudKit  
❌ Нет "живой синхронизации" между устройствами  
❌ Нет хранения runtime-state вне SwiftData  
...
❌ Нет бизнес-логики и CRUD в View  
❌ Нет "магических" переходов между экранами без понятного источника состояния  
❌ Нет переключателей темы  
❌ Нет light-палитры
...
❌ Нет хранения персональных данных в логах  
❌ Нет использования сторонних SDK без необходимости  
❌ Нет зависимости Core от UI
