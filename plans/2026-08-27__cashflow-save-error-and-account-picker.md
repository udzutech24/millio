...
6. [ ] **Шаг 2 — редизайн пикера** отдельной веткой: bottom sheet, избранные,
   остатки, монограммы + перевод transfer-меню (`~:1220`) на тот же компонент
   вместе с фиксом резолва валюты (риск 4).
