...
Дата: 2026-09-06 · Статус: в работе (Ф0–Ф3 в develop, Ф4–Ф6 pending) · Sidecar: `2026-09-06__account-screens-unification.status.json`
...
### Ф2 Наличные — `[x]` СМЕРЖЕНО в develop (08.09.2026, `34bea9f`, по «да» владельца)
...
merge-коммит `34bea9f`. Следом `04c8d4d` — «Сверка наличных» переименована в «Сумма наличных / Изменить».
...
**Осталось по Ф2:** device-проверка на релиз-кандидате 2.0 (создание наличных из пикера + сверка на экране) — не блокирует мерж, он уже сделан.

### Ф3 Кредит — `[x]` СМЕРЖЕНО в develop (08.09.2026, `c070c0a`, по «да» владельца)
...
запушены, билд 2.0 (2) стоял на iPhone владельца. Ф3 смержена в `develop` merge-коммитом `c070c0a`.
Осталось: device-проверка на релиз-кандидате 2.0 (не блокирует мерж, он уже сделан).
⚠️ Отклонение, подтверждено владельцем: плановый платёж — разовая пересоздаваемая
